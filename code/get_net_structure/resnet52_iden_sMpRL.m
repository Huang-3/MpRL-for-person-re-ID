function net = resnet52_iden_sMpRL(num_predefined_classes, dropoutrate)
...
net.addLayer('loss_pseudo',dagnn.Pseudo_Loss_Multi_Static(),{'prediction','label', 'multipse_label'},'objective_multi_pseudo');
