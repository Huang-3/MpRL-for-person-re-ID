function net = resnet52_iden_MpRL2(num_predefined_classes, dropoutrate)
...
net.addLayer('loss_pseudo',dagnn.Pseudo_Loss_Multi_Dynamic_1(),{'prediction','label'},'objective_multi_pseudo');
