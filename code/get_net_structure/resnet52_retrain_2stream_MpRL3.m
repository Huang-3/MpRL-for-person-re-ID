function nn = resnet52_retrain_2stream_MpRL3(num_predefined_classes, dropoutrate)
%The baseline model
% Concat two model.

net1 = resnet52_iden_MpRL3(num_predefined_classes, dropoutrate);
net1.removeLayer('top5err');
net2 = resnet52_iden_MpRL3(num_predefined_classes, dropoutrate); %imagenet
