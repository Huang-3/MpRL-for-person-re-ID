function train_res_iden_MpRL2(num_predefined_classes, dropoutrate, num_real, num_gan, varargin)
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
net = resnet52_iden_MpRL2(num_predefined_classes, dropoutrate);
...
opts.train.expDir = strcat('./result/res52_iden_MpRL2',num2str(num_gan));
...
% --------------------------------------------------------------------
% if(opts.epoch>0)  % after 20 epoch we start using pseudo label.
