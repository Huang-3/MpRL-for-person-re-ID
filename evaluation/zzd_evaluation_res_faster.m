...
%% add necessary paths
query_dir = '/home/yan/datasets/Market-1501-v15.09.15/query/';% query directory
test_dir = '/home/yan/datasets/Market-1501-v15.09.15/bounding_box_test/';% database directory

%% calculate query features
Hist_query = importdata(fullfile('./test', path, 'resnet_query.mat'))';
nQuery = size(Hist_query, 2);

%% calculate database features
Hist_test = importdata(fullfile('./test', path, 'resnet_gallery.mat'))';
